...
$string['activitycompletion_impact'] = 'Course activity completion is currently disabled, however, some activities still have their completion settings set, which could cause problems with assignment submissions.';
